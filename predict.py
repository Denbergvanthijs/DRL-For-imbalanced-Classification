...
min_class = [0]  # Minority classes, must be same as trained model
maj_class = [1]  # Majority classes, must be same as trained model

x_train, y_train, x_test, y_test = load_data("credit")  # Load data to predict
